...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Monday, ABBCCoin Altcoin 18-APR-19 07:34:11 UTC";
                CTransaction txNew;
                txNew.nTime = 1555600084;
                txNew.vin.resize(1);
                txNew.vout.resize(1);
                ...
                block.nVersion = 1;
                block.nTime    = 1555600084; //Friday, 24-Mar-17 02:44:04 UTC
                ...
                //// debug print
                assert(block.hashMerkleRoot == uint256("0x219a10fcc13372b10604fd5bbba78dce380b9fdf71bab117afb7349dab786804"));
                block.print();
...
unsigned char pchMessageStart[4] = { 0xC0, 0xFF, 0x92, 0x5D  };
